...
import ArticleView from "../views/LandingPages/Articles/ArticleView.vue"
import OurTeamView from "../views/LandingPages/OurTeam/OurTeamView.vue"
import SignInBasicView from "../views/LandingPages/SignIn/BasicView.vue";
import LoginLoginView from "../views/LandingPages/Login/LoginView.vue";
...
const router = createRouter({
  ...
  routes: [
    ...
    {
      path: "/landing-pages/author",
      name: "author",
      component: AuthorView,
    },

    {
      path: "/landing-pages/basic",
      name: "signin-basic",
