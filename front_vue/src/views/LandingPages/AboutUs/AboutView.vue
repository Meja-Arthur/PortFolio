...
//image
import bg0 from "@/assets/img/nastuh.jpg";
...
import Services from './Sections/UsServices.vue'
      ...
      <div class="container">
        <div class="row justify-content-center">
          ...
          <div class="col-lg-8 text-center mx-auto my-auto">
            ...
            <h1 class="text-white">
              Work with us Cause we  <span class="text-white" id="typed"></span>
            </h1>

            <div id="typed-strings">
              <h1> are a Team</h1>
              <h1>are Transparent</h1>
              <h1>Care</h1>
            </div>

            <p class="lead mb-4 text-white opacity-8">
              SomeThing Should Be Here Tooh 
            </p>
