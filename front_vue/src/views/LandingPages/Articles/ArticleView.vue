...
//image
import bg0 from "@/assets/img/office-dark.jpg";
      ...
      <div class="container">
        <div class="row justify-content-center">
          ...
          <div class="col-lg-8 text-center mx-auto my-auto">
            ...
            <h1 class="text-white">
              We care <span class="text-white" id="typed"></span>
            </h1>
            ...
            <p class="lead mb-4 text-white opacity-8">SomeThing Should Be Here Tooh </p>
