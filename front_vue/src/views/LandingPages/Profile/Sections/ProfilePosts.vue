...
<template>
  ...
  <section class="py-3">
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-6">
          <h2 class="mb-5">Check my latest blogposts</h2>
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-sm-6">
          <TransparentBlogCard :image="post1" title="Rover raised $65 million"
            ...
            should be as easy as renting an Airbnb. That’s the idea behind Rover ..."
          />
        </div>

        <div class="col-lg-3 col-sm-6">
          <TransparentBlogCard :image="post2" title="MateLabs machine learning"
            description="If you’ve ever wanted to train a machine learning model 
        ...
        <div class="col-lg-3 col-sm-6">
          <TransparentBlogCard :image="post3" title="MateLabs machine learning"
            description="If you’ve ever wanted to train a machine learning model and integrate 
